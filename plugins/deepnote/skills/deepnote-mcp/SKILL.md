...
If the Deepnote MCP server is not available in the current session, say that clearly and ask the user to connect or configure the Deepnote app. Do not pretend to have inspected Deepnote state.

The plugin config registers the Deepnote app under the app id `asdk_app_69fb51f9519081919c1f3e44ea9a5a05`.
